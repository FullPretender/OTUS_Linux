...
Задание буду выполнять на предложенном стенде https://github.com/Nickmob/vagrant_selinux, заранее разверну его через Vagrant 
...
Такой контекст конфиги получили из-за того, что лежат в другой директории, на которую распространяется иной контекст.
...
После изменения возвращаюсь на клиент и снова пробую внести изменения. 
